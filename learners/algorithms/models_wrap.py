...
class ModelLearner(learner.Learner):
    ...
    def __init__(self, cfg):
        ...
        m_bounds = [c.bounds for c in self._m_channels]
        self.learner = models.learner.Learner(range(-len(self._m_channels), 0), range(len(self.s_channels)),
    ...
    def _predict(self, m_signal):
        ...
        m_vector = tools.to_vector(m_signal, self._m_channels)
